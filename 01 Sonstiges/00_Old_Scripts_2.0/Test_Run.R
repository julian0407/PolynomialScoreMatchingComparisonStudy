...
# A) Global settings
# ------------------------------------------------------------
sample_sizes_main <- c(50, 100, 200, 500)
sample_sizes_bias_variance <- c(50, 100, 200, 500)
...
make_sm_specs_1d <- function(m_values = c(1, 2, 3),
...
# ------------------------------------------------------------
make_sm_specs_1d_noridge <- function(m_values = c(1, 2, 3),
                                     score_metric_args = score_metric_args_default,
                                     density_metric_args = density_metric_args_default) {
  lapply(m_values, function(m) {
    list(
...
# ------------------------------------------------------------
make_sm_specs_1d_ridge <- function(m_values = c(1, 2, 3),
                                   ridge = 1e-2,
                                   score_metric_args = score_metric_args_default,
                                   density_metric_args = density_metric_args_default) {
  lapply(m_values, function(m) {
