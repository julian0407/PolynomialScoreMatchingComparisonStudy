# ============================================================
# run_patched_compare.R
# Führt Vergleichsläufe mit den patched Skripten aus
...
# source("Final_Univariate_Test_Template_patched.R")  # optional
...
compare_score_metric_args <- list(
  robust = "none",
  trim_alpha = 0.05
)
...
saveRDS(patched_results, file = "patched_compare_results_seed123.rds")
cat("Patched results saved to patched_compare_results_seed123.rds\n")