...
score_metric_args_default <- list(
  robust = "none",
  trim_alpha = 0.05,
  center = "median"   # alternativ: "median"
)
...
plot_metric_comparison(sm_logistic_candidates, metric = "kl", use_median = TRUE)
plot_metric_comparison(sm_logistic_candidates, metric = "score_loss", use_median = TRUE)
