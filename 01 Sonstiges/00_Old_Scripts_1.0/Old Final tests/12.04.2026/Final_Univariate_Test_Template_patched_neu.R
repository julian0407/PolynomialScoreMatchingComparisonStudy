...
# robust steuert run-intern direkt die Aggregation der punktweisen Score-Fehler:
# "none" = Mittelwert, "trim" = getrimmter Mittelwert,
# "winsor" = winsorisierter Mittelwert, "median" = Median
...
sm_logistic_candidates <- run_family_selection_benchmark(
  truth = truth_logistic,
  estimator_specs = make_sm_specs_1d(m_values = c(5, 6)),
  n_rep = 10,
  n_test = 1000
)

plot_final_benchmark(sm_logistic_candidates, metric = "negloglik", center = "median", interval = "none")
plot_final_benchmark(sm_logistic_candidates, metric = "kl", center = "median")
