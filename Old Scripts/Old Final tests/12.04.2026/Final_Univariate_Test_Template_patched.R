...
plot_final_benchmark(sm_gaussian_candidates, metric = "kl", interval = "none")
plot_metric_comparison(sm_gaussian_candidates, metric = "kl", use_median = TRUE)
plot_final_benchmark(sm_gaussian_candidates, metric = "score_loss", center = "median", interval = "none")
...
sm_gaussian_candidates_filtered <- subset_final_benchmark(
  ...
  drop_n = c(50, 100),
  drop_method_labels = c("SM_m5", "SM_m4"),
)

plot_final_benchmark(sm_gaussian_candidates_filtered, metric = "kl", interval = "none", center = "median")
plot_final_benchmark(sm_gaussian_candidates_filtered, metric = "score_loss", interval = "none", center = "mean")
...
plot_final_benchmark(sm_logistic_candidates, metric = "kl", center = "median", interval = "none")
...
sm_logistic_candidates_filtered <- subset_final_benchmark(
  ...
  drop_method_labels = c("SM_m6", "SM_m2"),
  drop_n = c(50, 100)
)

plot_final_benchmark(sm_logistic_candidates_filtered, metric = "negloglik", center = "median", interval = "none")
plot_final_benchmark(sm_logistic_candidates_filtered, metric = "kl", center = "median")
